...
/* Generated types for 0xc4049b2d1cc0f6e017fda8260e4377cecd236bd7f56a54fee120816e72e2e0dd, original address 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c */
...
export class events extends SuiBaseProcessor {
  ...
  onEventDepositEventV2(
    func: (event: events.DepositEventV2Instance, ctx: SuiContext) => void,
    fetchConfig?: Partial<MoveFetchConfig>,
  ): events {
    this.onMoveEvent(func, { type: "events::DepositEventV2" }, fetchConfig);
    return this;
  }
  ...
  onEventSwapEventV2(
    func: (event: events.SwapEventV2Instance, ctx: SuiContext) => void,
    fetchConfig?: Partial<MoveFetchConfig>,
  ): events {
    this.onMoveEvent(func, { type: "events::SwapEventV2" }, fetchConfig);
    return this;
  }
  ...
  onEventWithdrawEventV2(
    func: (event: events.WithdrawEventV2Instance, ctx: SuiContext) => void,
    fetchConfig?: Partial<MoveFetchConfig>,
  ): events {
    this.onMoveEvent(func, { type: "events::WithdrawEventV2" }, fetchConfig);
    return this;
  }
}
...
export namespace events {
  ...
  export interface DepositEventV2 {
    pool_id: _0x2.object$.ID;
    issuer: string;
    referrer: _0x1.option.Option<string>;
    types: _0x1.ascii.String[];
  ...
  export namespace DepositEventV2 {
    export const TYPE_QNAME =
      "0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::events::DepositEventV2";

    const TYPE = new TypeDescriptor<DepositEventV2>(DepositEventV2.TYPE_QNAME);

    export function type(): TypeDescriptor<DepositEventV2> {
      return TYPE.apply();
    }
  }

  export type DepositEventV2Instance = TypedEventInstance<DepositEventV2> & {
    data_decoded: DepositEventV2;
    type_arguments: [];
  };
  ...
  export namespace SwapEventV2 {
    export const TYPE_QNAME =
      "0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::events::SwapEventV2";

    const TYPE = new TypeDescriptor<SwapEventV2>(SwapEventV2.TYPE_QNAME);

    export function type(): TypeDescriptor<SwapEventV2> {
      return TYPE.apply();
    }
  }

  export type SwapEventV2Instance = TypedEventInstance<SwapEventV2> & {
    data_decoded: SwapEventV2;
    type_arguments: [];
  };
  ...
  export interface WithdrawEventV2 {
    pool_id: _0x2.object$.ID;
    issuer: string;
    referrer: _0x1.option.Option<string>;
    types: _0x1.ascii.String[];
  ...
  export namespace WithdrawEventV2 {
    export const TYPE_QNAME =
      "0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::events::WithdrawEventV2";

    const TYPE = new TypeDescriptor<WithdrawEventV2>(
      WithdrawEventV2.TYPE_QNAME,
    );

    export function type(): TypeDescriptor<WithdrawEventV2> {
      return TYPE.apply();
    }
  }

  export type WithdrawEventV2Instance = TypedEventInstance<WithdrawEventV2> & {
    data_decoded: WithdrawEventV2;
    type_arguments: [];
  };
...
export namespace pool_registry {
  ...
  export namespace builder {
    ...
    export function currentProtocolVersion(
      tx: Transaction,
      args: [],
    ): TransactionArgument & [] {
      const _args: any[] = [];
      ...
      return tx.moveCall({
        target:
          "0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool_registry::current_protocol_version",
        arguments: _args,
      });
    }
    ...
    export function upgrade(
      ...
      return tx.moveCall({
        target:
          "0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool_registry::upgrade",
        arguments: _args,
      });
    }
  }
  export namespace view {
    ...
    export async function currentProtocolVersion(
      client: SuiClient,
      args: [],
    ): Promise<TypedDevInspectResults<[bigint]>> {
      const tx = new Transaction();
      builder.currentProtocolVersion(tx, args);
      const inspectRes = await client.devInspectTransactionBlock({
        transactionBlock: tx,
        sender: ZERO_ADDRESS,
      });
...
export namespace protocol_fees {
  export namespace builder {
    ...
    export function collectFees1Coins<T0 = any>(
      tx: Transaction,
      args: [
        string | TransactionObjectArgument | TransactionArgument,
        string | TransactionObjectArgument | TransactionArgument,
      ...
      return tx.moveCall({
        target:
          "0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::protocol_fees::collect_fees_1_coins",
        arguments: _args,
        typeArguments: [
          typeof typeArguments[0] === "string"
            ? typeArguments[0]
  ...
  export namespace view {
    ...
    export async function collectFees1Coins<T0 = any>(
      client: SuiClient,
      args: [string, string, string, string, string, string],
      typeArguments: [TypeDescriptor<T0> | string],
    ): Promise<TypedDevInspectResults<[]>> {
      const tx = new Transaction();
      builder.collectFees1Coins(tx, args, typeArguments);
      const inspectRes = await client.devInspectTransactionBlock({
        transactionBlock: tx,
        sender: ZERO_ADDRESS,
      });
